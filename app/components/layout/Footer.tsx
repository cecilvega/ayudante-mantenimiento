...
import { ClipboardListIcon, ShieldIcon, WrenchIcon, HomeIcon } from 'lucide-react'
                    ...
                    <Link href="/." passHref>
                        ...
                        >
                            <div className="flex flex-col items-center">
                                ...
                                <span className="text-xs font-semibold text-center">Inicio</span>
                            </div>
                        </Button>
                    </Link>
                    <Link href="/registro-asistencia" passHref>
                        <Button
                            variant="ghost"
                            className="w-full h-16 text-white hover:bg-white hover:text-[#140a9a] transition-colors duration-300"
                        >
                            <div className="flex flex-col items-center">
                                ...
                                <span className="text-xs font-semibold text-center">Registro</span>
                            </div>
                        </Button>
                    </Link>
                    <Link href="/mantenimiento" passHref>
                        ...
                        >
                            <div className="flex flex-col items-center">
                                ...
                                <span className="text-xs font-semibold text-center">Mantención</span>
                            </div>
                        </Button>
                    </Link>
