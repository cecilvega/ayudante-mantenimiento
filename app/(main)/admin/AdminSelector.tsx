      ...
      <main className="flex-grow flex items-center justify-center p-4">
        <Card className="w-full max-w-4xl mx-auto shadow-lg">
          ...
          <CardContent className="p-6">
            <Alert
              variant="default"
              className="mb-6 bg-yellow-50 border-yellow-200 text-yellow-800"
            >
              ...
              <AlertDescription className="text-sm text-yellow-700">
                Los cambios en la administración deben realizarse con
                precaución. Solo Cristian Salazar está autorizado para
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 break-words">
                      Gestionar categorías, cargos y personas
                    </p>
                  </div>
                </Button>
              </Link>
